...
function noteOn(note, velocity) {
    ...
    const velocityGainValue = (velocity / 127) * volumeValue;
    ...
    oscillators[note.toString()] = { osc: osc1, gain: osc1Gain, filter: filter, frequency: osc1.frequency, releaseTime: releaseTime };
    osc1.start();
